...
entity solve_linear_equations_solve_linear_equations_Pipeline_VITIS_LOOP_27_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of solve_linear_equations_solve_linear_equations_Pipeline_VITIS_LOOP_27_5 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln27_reg_211 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal j_2_reg_201 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal icmp_ln27_fu_149_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln27_reg_211_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal A_local_load_reg_220 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal mul53_i_reg_230 : STD_LOGIC_VECTOR (31 downto 0);
    signal sub56_i_reg_240 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage2_subdone : BOOLEAN;
    signal zext_ln28_fu_140_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal sub5618_i_fu_40 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_sub5618_i_load_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage2 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal j_fu_44 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln27_fu_154_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln27_cast_fu_113_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage2_01001 : BOOLEAN;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_block_pp0_stage3 : BOOLEAN;
    signal trunc_ln28_fu_131_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln28_1_fu_135_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal trunc_ln27_fu_145_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                elsif (((icmp_ln27_reg_211 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    sub5618_i_fu_40_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln27_reg_211 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_block_pp0_stage4_subdone, ap_block_pp0_stage2_subdone, ap_condition_exit_pp0_iter1_stage2, ap_idle_pp0_0to0, ap_block_pp0_stage0_subdone, ap_idle_pp0_1to2, ap_done_pending_pp0, ap_block_pp0_stage1_subdone, ap_block_pp0_stage3_subdone, ap_start_int)
    begin
        case ap_CS_fsm is
    ...
    A_local_address0 <= zext_ln28_fu_140_p1(11 - 1 downto 0);

    A_local_ce0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001)
    begin
    ...
    X_local_address0 <= j_fu_44(6 - 1 downto 0);
    ...
    add_ln27_fu_154_p2 <= std_logic_vector(unsigned(j_2_reg_201) + unsigned(ap_const_lv64_1));
    add_ln28_1_fu_135_p2 <= std_logic_vector(unsigned(add_ln28) + unsigned(trunc_ln28_fu_131_p1));
    ...
    ap_condition_exit_pp0_iter0_stage4_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage4, ap_block_pp0_stage4_subdone, icmp_ln27_reg_211)
    begin
        if (((icmp_ln27_reg_211 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage4_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4))) then 
    ...
    ap_condition_exit_pp0_iter1_stage2_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln27_reg_211_pp0_iter1_reg, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (icmp_ln27_reg_211_pp0_iter1_reg = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_sub5618_i_load_1_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage2, sub56_i_reg_240, sub5618_i_fu_40, ap_block_pp0_stage2)
    begin
    ...
    grp_fu_1156_p_din0 <= A_local_load_reg_220;
    grp_fu_1156_p_din1 <= X_local_load_reg_225;
    grp_fu_339_p_ce <= ap_const_logic_1;
    grp_fu_339_p_din0 <= ap_sig_allocacmp_sub5618_i_load_1;
    grp_fu_339_p_din1 <= mul53_i_reg_230;
    grp_fu_339_p_opcode <= ap_const_lv2_1;
    icmp_ln27_fu_149_p2 <= "1" when (trunc_ln27_fu_145_p1 = select_ln27) else "0";
        sext_ln27_cast_fu_113_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln27),64));

    sub5618_i_out <= sub5618_i_fu_40;

    sub5618_i_out_ap_vld_assign_proc : process(icmp_ln27_reg_211_pp0_iter1_reg, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (icmp_ln27_reg_211_pp0_iter1_reg = ap_const_lv1_1))) then 
            sub5618_i_out_ap_vld <= ap_const_logic_1;
        else 
            sub5618_i_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    trunc_ln27_fu_145_p1 <= j_fu_44(32 - 1 downto 0);
    trunc_ln28_fu_131_p1 <= j_fu_44(11 - 1 downto 0);
    zext_ln28_fu_140_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln28_1_fu_135_p2),64));
end behav;
