...
entity solve_linear_equations_control_s_axi is
generic (
...
end entity solve_linear_equations_control_s_axi;
...
architecture behave of solve_linear_equations_control_s_axi is
    ...
    constant ADDR_X_DATA_0 : INTEGER := 16#30#;
    constant ADDR_X_DATA_1 : INTEGER := 16#34#;
    constant ADDR_X_CTRL   : INTEGER := 16#38#;
